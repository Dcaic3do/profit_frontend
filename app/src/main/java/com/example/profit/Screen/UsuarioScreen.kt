                            ...
                            if (usuario.isNotEmpty() && correoElectronico.isNotEmpty() && contrasena.isNotEmpty() && objetivoSeleccionado != null && caloriaDiarias.isNotEmpty()) {
                                scope.launch {
                                    val nuevoUsuario = Usuario(
                                        ...
                                        caloriaDiarias = caloriaDiarias.toLong()
                                    )
                                    ...
                                    Toast.makeText(context, "Usuario Insertado", Toast.LENGTH_SHORT)
                                        .show()
                                    viewModel.listarUsuarios()
                                }
                            }
                            ...
                            items(usuariosFiltrados) { usuarios ->
                                Card(
                                    ...
                                    Column(modifier = Modifier.padding(16.dp)) {
                                        ...
                                        val nombreObjetivoUsuario =
                                            listarObjetivos.find { it.idObjetivo == usuarios.objetivo }?.objetivo
                                                ?: "Sin objetivo"
                                        Text(
